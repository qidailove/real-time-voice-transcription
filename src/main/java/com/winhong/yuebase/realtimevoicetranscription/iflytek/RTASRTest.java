package com.winhong.yuebase.realtimevoicetranscription.iflytek;
...
public class RTASRTest {
    ...
    // appid
    private static final String APPID = "a6d41292";

    // appid对应的secret_key
    private static final String SECRET_KEY = "930924b08d80417e8b6661dd7ed456b7";
    ...
    // 音频文件路径
    private static final String AUDIO_PATH = "src/main/resources/voice/gg.pcm";
    ...
    public static String getHandShakeParams(String appId, String secretKey) {
        ...
        try {
            ...
            return "?appid=" + appId + "&ts=" + ts + "&signa=" + URLEncoder.encode(signa, "UTF-8") + "&roleType=2";
        } catch (Exception e) {
            e.printStackTrace();
        }
